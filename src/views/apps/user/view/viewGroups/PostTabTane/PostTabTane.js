              ...
              <Col md="6">
                ...
                <Row className="mt-1">
                  <Col md="6">
                    <div className="form-check form-check-inline">
                      <Input type="checkbox" />
                      <Label className="w-100">Tự động đăng lúc</Label>
                    </div>
                  </Col>
                  <Col>
                    <Flatpickr
                ...
                <div className="form-check">
                  <Input type="checkbox" />
                  <Label>Thích bài viết sau khi đăng</Label>
                </div>
                <div className="form-check">
                  <Input type="checkbox" />
                  <Label>Cho phép úp tin bài đăng thành công</Label>
                </div>
                <div className="form-check">
                  <Input type="checkbox" />
                  <Label>
                    Cho phép chạy tương tác chéo bài đăng thành công
                  </Label>
                </div>
                <div className="form-check">
                  <Input type="checkbox" />
                  <Label className="fw-bolder">Không đăng lên nhóm có phê duyệt</Label>
                </div>
              </Col>
            </Row>
          </Row>
